              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-slate-950 border border-slate-800 focus:border-indigo-500 rounded-lg py-3 pl-4 pr-12 text-white placeholder-slate-600 focus:outline-none transition-colors"
                    disabled={loading}
